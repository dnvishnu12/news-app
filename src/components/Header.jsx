      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="#">Trending</MobileNavItem>
            <MobileNavItem href="#">Insights</MobileNavItem>
            <MobileNavItem href="#">More</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
    ...
    >
      <div
        className={clsx(
          ...
          large ? 'h-16 w-16 text-4xl' : 'h-9 w-9 text-2xl',
        )}
      >
        <FcScatterPlot />
      </div>
